...
urlFragment: HHH_ConnectAzureEntraID
...
```console
git clone https://github.com/AzureADQuickStarts/HHH_ConnectAzureEntraID.git
cd HHH_ConnectAzureEntraID
```
...
1. Open the `HHH_ConnectAzureEntraID\Web.config` file.
